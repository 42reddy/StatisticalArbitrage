...
TICKERS = [
    "HAL.NS", "BDL.NS", "COCHINSHIP.NS", "MAZDOCK.NS", "BEL.NS",
    "SUPREMEIND.NS", "CUMMINSIND.NS", "BLUESTARCO.NS",
    "HAVELLS.NS", "VOLTAS.NS", "WHIRLPOOL.NS", "KAYNES.NS"
]
...
if __name__ == '__main__':
    ...
    if results:
        ...
        df_out.to_csv(os.path.join(RESULTS_TABLES, 'pair_screen_results.csv'), index=False)
